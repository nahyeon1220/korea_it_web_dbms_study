...
//-> 내가 직접 SQL문을 작성하고, 그 결과를 JAVA 객체로 매핑
//SQL을 직접 짜기 때문에 완전히 통제 가능 (자유도 높음), 대신 코드가 복잡하고 반복적
@RestController
@RequestMapping("/user")
public class UserController {
    ...
    //요청 메소드 중 DELETE, PUT이 있는데 POST를 사용하는 이유
    //1. 보안상
    //2. 호환성
    //일부 브라우저, 서버가 PUT, DELETE를 완벽하게 지원하지 않음
